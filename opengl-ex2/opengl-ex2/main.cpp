...
void Init()
{
 ...
 /// GIve the right location for texturing ......
	...
	pix[2].readBMPFile("jack.bmp");
	pix[2].setTexture(3);

	pix[3].readBMPFile("road.bmp");
	pix[3].setTexture(4);

    pix[4].readBMPFile("cone.bmp");
	pix[4].setTexture(5);
	pix[5].readBMPFile("car.bmp");
	pix[5].setTexture(6);
}
...
*/
        ...
        case 'j':
            if (camera_y_look > -10)
                camera_y_look = camera_y_look - 0.1;
            else
                camera_y_look = camera_y_look;
            break;
        case 'u':
            if (camera_y_look < 10)
                camera_y_look = camera_y_look + 0.1;
